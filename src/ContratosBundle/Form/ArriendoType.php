...
class ArriendoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('arrendador_natural_estado_civil', 'choice', array('label' => 'Estado civil', 'placeholder' => 'Seleccione una opción', 'choices' => array('Soltero' => 'Soltero', 'Casado' => 'Casado', 'Divorciado' => 'Divorciado', 'Viudo' => 'Viudo')))
            ...
            ->add('arrendador_natural_region', 'choice', array('label' => 'Región', 'placeholder' => 'Seleccione una opción', 'choices' => array(
            ...
            ->add('arrendador_natural_comuna', 'choice', array('label' => 'Comuna', 'placeholder' => 'Seleccione una opción'))
            ...
            ->add('arrendador_juridica_region', 'choice', array('label' => 'Región', 'placeholder' => 'Seleccione una opción', 'choices' => array(
                'XV de Arica y Parinacota' => 'XV de Arica y Parinacota',
                'I de Tarapacá' => 'I de Tarapacá',
                'II de Antofagasta' => 'II de Antofagasta',
                'III de Atacama' => 'III de Atacama',
            ...
            ->add('arrendador_juridica_comuna', 'choice', array('label' => 'Comuna', 'placeholder' => 'Seleccione una opción'))
            ...
            ->add('arrendatario_natural_estado_civil', 'choice', array('label' => 'Estado civil', 'placeholder' => 'Seleccione una opción', 'choices' => array('Soltero' => 'Soltero', 'Casado' => 'Casado', 'Divorciado' => 'Divorciado', 'Viudo' => 'Viudo')))
            ...
            ->add('arrendatario_natural_region', 'choice', array('label' => 'Región', 'placeholder' => 'Seleccione una opción', 'choices' => array(
                'XV de Arica y Parinacota' => 'XV de Arica y Parinacota',
                'I de Tarapacá' => 'I de Tarapacá',
                'II de Antofagasta' => 'II de Antofagasta',
                'III de Atacama' => 'III de Atacama',
            ...
            ->add('arrendatario_natural_comuna', 'choice', array('label' => 'Comuna', 'placeholder' => 'Seleccione una opción'))
            ...
            ->add('arrendatario_juridica_region', 'choice', array('label' => 'Región', 'placeholder' => 'Seleccione una opción', 'choices' => array(
                'XV de Arica y Parinacota' => 'XV de Arica y Parinacota',
                'I de Tarapacá' => 'I de Tarapacá',
                'II de Antofagasta' => 'II de Antofagasta',
                'III de Atacama' => 'III de Atacama',
            ...
            ->add('arrendatario_juridica_comuna', 'choice', array('label' => 'Comuna', 'placeholder' => 'Seleccione una opción'))
            ...
            ->add('propiedad_region', 'choice', array('label' => 'Región', 'placeholder' => 'Seleccione una opción', 'choices' => array(
                'XV de Arica y Parinacota' => 'XV de Arica y Parinacota',
                'I de Tarapacá' => 'I de Tarapacá',
                'II de Antofagasta' => 'II de Antofagasta',
                'III de Atacama' => 'III de Atacama',
            ...
            ->add('propiedad_comuna', 'choice', array('label' => 'Comuna', 'placeholder' => 'Seleccione una opción'))
            ->add('plazo_unidad', 'choice', array('label' => 'Unidad de tiempo', 'placeholder' => 'Seleccione una opción', 'choices' => array('Dias' => 'Días', 'Semanas' => 'Semanas', 'Meses' => 'Meses')))
            ...
            ->add('renta_medio_pago', 'choice', array('label' => 'Medios de pago', 'expanded' => true, 'choices' => array('en efectivo' => 'en efectivo', 'con cheque' => 'con cheque', 'mediante un depósito en Cuenta Corriente' => 'mediante un depósito en Cuenta Corriente')))
            ...
            ->add('renta_medio_deposito_tipo', 'choice', array('label' => 'Tipo de cuenta', 'placeholder' => 'Seleccione una opción', 'choices' => array('Corriente' => 'Corriente', 'Vista' => 'Vista', 'Ahorro' => 'Ahorro')))
            ->add('renta_medio_deposito_numero', null, array('label' => 'Número'))
            ->add('renta_medio_deposito_banco', 'choice', array('label' => 'Banco', 'placeholder' => 'Seleccione una opción'))
            ->add('renta_medio_deposito_envio', null, array('label' => 'Forma de envío de comprobante de pago'))
            ->add('renta_medio_reajuste', 'choice', array('label' => 'Forma de reajuste', 'expanded' => true, 'choices' => array('No se reajustará' => 'No se reajustará', 'Si se reajustará' => 'Si se reajustará')))
            ...
            ->add('renta_mora_sancion', 'choice', array('label' => 'Sanción para la mora', 'expanded' => true, 'choices' => array('No habrá sanción' => 'No habrá sanción', 'Si habrá sanción' => 'Si habrá sanción') ))
            ...
            ->add('renta_cobranza', 'choice', array('label' => 'Multa por cobranza extrajudicial', 'expanded' => true, 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
            ->add('renta_cobranza_plazo', null, array('label' => 'Plazo de gracia para cobranza'))
            ->add('renta_cobranza_notificacion', 'choice', array('label' => 'Forma de notificar acciones de cobranza judicial', 'placeholder' => 'Seleccione una opción'))
            ->add('renta_cobranza_avaluo', 'choice', array('label' => 'Avaluación anticipada de la cobranza judicial', 'placeholder' => 'Seleccione una opción'))
            ->add('entrega_fecha', 'datetime', array('label' => 'Entrega del inmueble se realiza a la fecha del presente contrato'))
            ->add('entrega_inventario', 'choice', array('label' => 'Se realizará inventario de los bienes', 'expanded' => true, 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
            ->add('restitucion_forma', null, array('label' => 'Forma de restitución del inmueble'))
            ->add('restitucion_acreditacion', 'choice', array('label' => 'Acreditación del pago del servicios básicos', 'placeholder' => 'Seleccione una opción', 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
            ->add('restitucion_visita_plazo', null, array('label' => 'Plazo de visita habitantes del inmueble'))
            ->add('restitucion_visita_unidad', 'choice', array('label' => 'Unidad de tiempo', 'placeholder' => 'Seleccione una opción', 'choices' => array('Dias' => 'Días', 'Semanas' => 'Semanas', 'Meses' => 'Meses')))
            ->add('restitucion_inicio_plazo', null, array('label' => 'Plazo para iniciar reparaciones'))
            ->add('restitucion_inicio_unidad', 'choice', array('label' => 'Unidad de tiempo', 'placeholder' => 'Seleccione una opción', 'choices' => array('Dias' => 'Días', 'Semanas' => 'Semanas', 'Meses' => 'Meses')))
            ...
            ->add('recision_unidad', 'choice', array('label' => 'Unidad de tiempo', 'placeholder' => 'Seleccione una opción', 'choices' => array('Dias' => 'Días', 'Semanas' => 'Semanas', 'Meses' => 'Meses')))
            ->add('recision_causal', 'choice', array('label' => 'Agregar nueva causal de recisión del arrendador'))
            ->add('recision_causal_descripcion', null, array('label' => 'Cuál'))
            ->add('recision_unilateral', 'choice', array('label' => '¿Puede terminarse el contrato unilateralmente sin expresión de causa?', 'expanded' => true, 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
            ...
            ->add('recision_unilateral_unidad', 'choice', array('label' => 'Unidad de tiempo', 'choices' => array('Dias' => 'Días', 'Semanas' => 'Semanas', 'Meses' => 'Meses')))
            ...
            ->add('garantia_deposito', 'choice', array('label' => '¿Se deja depósito en garantía?', 'expanded' => true, 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
            ...
            ->add('garantia_unidad', 'choice', array('label' => 'Unidad de tiempo', 'placeholder' => 'Seleccione una opción', 'choices' => array('Dias' => 'Días', 'Semanas' => 'Semanas', 'Meses' => 'Meses')))
            ->add('aval', 'choice', array('label' => 'Se incluye aval', 'expanded' => true, 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
            ...
            ->add('aval_estado_civil', 'choice', array('label' => 'Estado civil', 'placeholder' => 'Seleccione una opción', 'choices' => array('Soltero' => 'Soltero', 'Casado' => 'Casado', 'Divorciado' => 'Divorciado', 'Viudo' => 'Viudo')))
            ...
            ->add('aval_region', 'choice', array('label' => 'Región', 'placeholder' => 'Seleccione una opción', 'choices' => array(
                'XV de Arica y Parinacota' => 'XV de Arica y Parinacota',
                'I de Tarapacá' => 'I de Tarapacá',
                'II de Antofagasta' => 'II de Antofagasta',
                'III de Atacama' => 'III de Atacama',
            ...
            ->add('aval_comuna', 'choice', array('label' => 'Comuna', 'placeholder' => 'Seleccione una opción'))
            ->add('correo', 'choice', array('label' => '¿Se incluye correo electrónico?', 'expanded' => true, 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
