...
class ArriendoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('arrendador_juridica_representante_sexo', 'choice', array('label' => 'Sexo', 'expanded' => true, 'choices' => array('Hombre' => 'Hombre', 'Mujer' => 'Mujer')))
            ->add('arrendador_juridica_representante_nombres', null, array('label' => 'Nombres'))
            ->add('arrendador_juridica_representante_apellido_paterno', null, array('label' => 'Apellido Paterno'))
            ->add('arrendador_juridica_representante_apellido_materno', null, array('label' => 'Apellido Materno'))
            ->add('arrendador_juridica_representante_nacionalidad', null, array('label' => 'Nacionalidad'))
            ->add('arrendador_juridica_representante_estado_civil', 'choice', array('label' => 'Estado civil', 'required' => false, 'placeholder' => 'Seleccione una opción', 'choices' => array('Soltero' => 'Soltero', 'Casado' => 'Casado', 'Divorciado' => 'Divorciado', 'Viudo' => 'Viudo')))
            ->add('arrendador_juridica_representante_rut', null, array('label' => 'RUT'))
            ...
            ->add('arrendatario_juridica_representante_sexo', 'choice', array('label' => 'Sexo', 'expanded' => true, 'choices' => array('Hombre' => 'Hombre', 'Mujer' => 'Mujer')))
            ->add('arrendatario_juridica_representante_nombres', null, array('label' => 'Nombres'))
            ->add('arrendatario_juridica_representante_apellido_paterno', null, array('label' => 'Apellido Paterno'))
            ->add('arrendatario_juridica_representante_apellido_materno', null, array('label' => 'Apellido Materno'))
            ->add('arrendatario_juridica_representante_nacionalidad', null, array('label' => 'Nacionalidad'))
            ->add('arrendatario_juridica_representante_estado_civil', 'choice', array('label' => 'Estado civil', 'required' => false, 'placeholder' => 'Seleccione una opción', 'choices' => array('Soltero' => 'Soltero', 'Casado' => 'Casado', 'Divorciado' => 'Divorciado', 'Viudo' => 'Viudo')))
            ->add('arrendatario_juridica_representante_rut', null, array('label' => 'RUT'))
            ...
            ->add('plazo_cantidad', null, array('label' => 'Cantidad de tiempo', 'required' => false))
            ->add('plazo_unidad', 'choice', array('label' => 'Unidad de tiempo', 'required' => false, 'placeholder' => 'Seleccione una opción', 'choices' => array('días' => 'Días', 'semanas' => 'Semanas', 'meses' => 'Meses', 'años' => 'Años')))
            ->add('plazo_momento', null, array('label' => 'Momento en el que entra en vigencia el contrato'))
            ->add('plazo_prorroga', 'choice', array('label' => 'Se prorroga tacitamente', 'expanded' => true, 'choices' => array(1 => 'Sí', 0 => 'No')))
            ...
            ->add('plazo_forma', 'choice', array('label' => 'Forma de Notificación del término del contrato', 'required' => false, 'placeholder' => 'Seleccione una opción', 'choices' => array('Carta Certificada enviada al domicilio del arrendador señalado en la comparecencia' => 'Carta Certificada enviada al domicilio del arrendador señalado en la comparecencia', 'Correo electrónico' => 'Correo electrónico', 'Otro' => 'Otro')))
            ->add('plazo_carta', null, array('label' => 'Otro', 'required' => false))
            ->add('renta_monto', null, array('label' => 'Renta de arrendamiento', 'required' => true))
            ->add('renta_unidad', 'choice', array('label' => 'Unidad de pago', 'required' => false, 'placeholder' => 'Seleccione una opción', 'choices' => array('Unidad de Fomento' => 'Unidad de Fomento', 'Pesos' => 'Pesos', 'Dólares' => 'Dólares')))
            ->add('renta_periodo', 'choice', array('label' => 'Período de pago', 'placeholder' => 'Seleccione una opción', 'choices' => array('mensualmente' => 'mensualmente', 'trimestralmente' => 'trimestralmente', 'semestralmente' => 'semestralmente', 'anualmente' => 'anualmente')))
            ...
            ->add('renta_medio_reajuste', 'choice', array('label' => 'Forma de reajuste', 'expanded' => true, 'choices' => array(0 => 'No se reajustará', 1 => 'Si se reajustará'), 'empty_data'  => 'No'))
            ...
            ->add('renta_mora_sancion', 'choice', array('label' => 'Sanción para la mora', 'expanded' => true, 'choices' => array(0 => 'No habrá sanción', 1 => 'Si habrá sanción'), 'empty_data'  => 'No'))
            ...
            ->add('renta_cobranza', 'choice', array('label' => 'Multa por cobranza xtrajudicial', 'expanded' => true, 'choices' => array(0 => 'No', 1 => 'Sí')))
            ...
            ->add('prohibicion_subarriendo', 'checkbox', array('label' => 'Subarrendar o transferir cualquier título el inmueble arrendado', 'required' => false))
            ->add('prohibicion_variaciones', 'checkbox', array('label' => 'Hacer variaciones o transformaciones que afecten la estructura interna o externa del inmueble arrendado sin autorización por escrito del ARRENDADOR', 'required' => false))
            ->add('prohibicion_utilizacion', 'checkbox', array('label' => 'Utilizar el inmueble con un fin distinto al que fue establecido en la cláusura primera del presente contrato', 'required' => false))
            ->add('prohibicion_retraso', 'checkbox', array('label' => 'Retrasarse en el pago de las cuentas de servicios básicos (luz, agua potable, gas), o en los gastos comunes', 'required' => false))
            ->add('prohibicion_perturbacion', 'checkbox', array('label' => 'Realizar cualquier acción que perturbe a los vecinos del inmueble, tales como ruidos molestos, u obras en el inmueble a horas inadecuadas, entre otras', 'required' => false))
            ->add('prohibicion_agujeros', 'checkbox', array('label' => 'Hacer agujeros en las paredes o puertas', 'required' => false))
            ->add('prohibicion_normativa', 'checkbox', array('label' => 'No cumplir con la normativa interna del condominio o edificio si corresponde', 'required' => false))
            ->add('prohibicion_accion_ilegal', 'checkbox', array('label' => 'Ejecutar cualquier acción ilegal, o contraria al orden público, en el interior del inmueble', 'required' => false))
            ...
            ->add('recision_causal', 'choice', array('label' => 'Agregar nueva causal de recisión del arrendador', 'choices' => array(0 => 'No', 1 => 'Sí')))
            ->add('recision_causal_descripcion', null, array('label' => 'Cuál'))
            ->add('recision_unilateral', 'choice', array('label' => '¿Puede terminarse el contrato unilateralmente sin expresión de causa?', 'expanded' => true, 'choices' => array(1 => 'Sí', 0 => 'No')))
            ...
            ->add('garantia_deposito', 'choice', array('label' => '¿Se deja depósito en garantía?', 'expanded' => true, 'choices' => array(1 => 'Sí', 0 => 'No'), 'empty_data'  => 'No'))
            ...
            ->add('aval', 'choice', array('label' => 'Se incluye aval', 'expanded' => true, 'choices' => array(1 => 'Sí', 0 => 'No')))
