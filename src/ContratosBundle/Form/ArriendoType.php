...
class ArriendoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('renta_medio_reajuste', 'choice', array('label' => 'Forma de reajuste', 'expanded' => true, 'choices' => array('No' => 'No se reajustará', 'Si' => 'Si se reajustará')))
            ...
            ->add('renta_mora_sancion', 'choice', array('label' => 'Sanción para la mora', 'expanded' => true, 'choices' => array('No' => 'No habrá sanción', 'Si' => 'Si habrá sanción') ))
            ...
            ->add('recision_causal', 'choice', array('label' => 'Agregar nueva causal de recisión del arrendador', 'choices' => array('Sí' => 'Sí', 'No' => 'No')))
